...
Color appbarColor = greyblackColor;
Color usersDrawerColor = greyblackColor;
Color flushBarnNegative = redColor = Color(getColorHexFromStr('#AA2728'));